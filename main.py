...
rdPlayer = rp.randomPlayer([(0,0),(0,1),(0,2),(1,0),(1,1),(1,2),(2,0),(2,1),(2,2)])
        ...
        while not valid:
            ...
            for each in inP:
                ...
                if not each.isdigit():
                    ...
                    valid = False
                    break
            if valid and board[int(inP[1])][int(inP[0])]!=" ":
                print("This position is occupied.")
                valid = False
        player.moveWithOpponent(1, (int(inP[0]),int(inP[1])))
        board[int(inP[1])][int(inP[0])] = "O"
        print(board)
        print()
    elif human=="random":
